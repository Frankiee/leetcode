...
# value is 0.
#
# Return an array of integers answer, where answer[i] = next_larger(node_{
# i+1}).
#
# Note that in the example inputs (not outputs) below, arrays such as [2,1,
# 5] represent the serialization of a linked list with a head node value of
