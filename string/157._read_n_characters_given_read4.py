...
# characters from the file, so return 3. Note that "abc" is the file's content, not buf. buf is
# the destination buffer that you will have to write the results to.
# Example 2:
#
...
# Output: 12
# Explanation: After calling your read method, buf should contain "abcdABCD1234". We read a total
# of 12 characters from the file, so return 12.
# Example 4:
#
# Input: file = "leetcode", n = 5
# Output: 5
# Explanation: After calling your read method, buf should contain "leetc". We read a total of 5
# characters from the file, so return 5.
#
#
# Note:
...
class Solution(object):
    def read(self, buf, n):
        ...
        while True:
            ...
            read_count = min(read4(buf4), n - idx)

            for i in range(read_count):
                buf[idx] = buf4[i]
                idx += 1

            if read_count < 4 or idx == n:
                return idx
