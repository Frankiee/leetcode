...
# 1,8,4,5]. From the head of B, it reads as [5,0,1,8,4,5]. There are 2 nodes
...
# not be 0 if the two lists intersect). From the head of A, it reads as [0,
# 9,1,2,4]. From the head of B, it reads as [3,2,4]. There are 3 nodes
