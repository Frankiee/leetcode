...
class Solution(object):
    def _find_lowest_left(self, heights, K):
        lowest_idx = None
    ...
    def _find_lowest_right(self, heights, K):
        lowest_idx = None
    ...
    def pourWater(self, heights, V, K):
        ...
        """
        for i in range(V):
            lowest_left_idx = self._find_lowest_left(heights, K)
            if lowest_left_idx is not None and heights[lowest_left_idx] < heights[K]:
                heights[lowest_left_idx] += 1
                continue

            lowest_right_idx = self._find_lowest_right(heights, K)
            if lowest_right_idx is not None and heights[lowest_right_idx] < heights[K]:
                heights[lowest_right_idx] += 1
                continue
