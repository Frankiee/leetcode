...
# the game;
#              No matter 1, 2, or 3 stones you remove, the last stone will
#              always be
...
# https://leetcode.com/problems/nim-game/discuss/73749/Theorem%3A-all-4s-shall-be-false   # noqa
# Theorem: The first one who got the number that is multiple of 4 (i.e. n %
# 4 == 0) will lost, otherwise he/she will win.
#
# Proof:
#
...
# initial number into 4 accordingly, which will leave the death number 4 to
# the second player. i.e. The numbers 5, 6, 7 are winning numbers for any
# player who got it first.
#
# Now to the beginning of the next cycle, n = 8, no matter which number that
# the first player picks, it would always leave the winning numbers (5, 6,
# 7) to the second player. Therefore, 8 % 4 == 0, again is a death number.
#
...
# because the first player can always reduce the number into the death
# number 8.
#
