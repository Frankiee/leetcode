...
# to insert a value insertVal into the list such that it remains a sorted circular list. The
# given node can be a reference to any single node in the list, and may not be necessarily the
...
# should be inserted between node 1 and node 3. After the insertion, the list should look like
# this, and we should still return node 3.
#
#
#
# Example 2:
