...
# can do so recursively, in other words from the previous member read off the digits, counting
...
class Solution(object):
    def _get_nxt_iter(self, text):
        ...
        for c in text:
            if curr_char is None:
                ...
                ret.append(str(curr_char_count))
    ...
    def countAndSay(self, n):
        ...
        for i in range(1, n):
            curr_str = self._get_nxt_iter(curr_str)
