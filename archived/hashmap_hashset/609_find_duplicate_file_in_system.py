...
# fn_content, respectively) in directory root/d1/d2/.../dm. Note that n >= 1 and m >= 0. If m =
# 0, it means the directory is just the root directory.
#
...
#
# Input:
# ["root/a 1.txt(abcd) 2.txt(efgh)", "root/c 3.txt(abcd)", "root/c/d 4.txt(efgh)", "root 4.txt(
# efgh)"]
# Output:
